...
env = flyte.TaskEnvironment(
    ...
    image=flyte.Image.from_debian_base(registry="localhost:30000").with_pip_packages("requests"),
)
...
if __name__ == "__main__":
    ...
    run = flyte.with_runcontext(mode="remote").run(main, x_list=list(range(10)))  # run remotely inline and pass data.
